...
parser.add_argument('--amc', action='store_true',
                    help='use amc configuration')
parser.add_argument('--m', type=float, default=1.0,
                    help='width mult', required=False)
...
def main():
    ...
    hyper_str = "gpu-{}-run_{}_lr_{:.4f}_decay_{}_b_{}_gpu_{}".format(args.num_gpus, args.epochs, args.lr, \
    ...
    args.model_save_path = \
            os.path.join(args.save, 'mbv2_{}.pth.tar'.format(hyper_str))

    #args.logging_file_path = \
    #        os.path.join(args.save, 'mbv2_{}.log'.format(hyper_str))
    ...
    #model = mobilenetv2(width_mult=args.m, amc=args.amc)
    model = mobilenetv2()
